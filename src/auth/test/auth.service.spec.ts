...
describe('AuthService', () => {
  ...
  let usersService: SmartwatchService;
  ...
  beforeEach(async () => {
    ...
    usersService = module.get<SmartwatchService>(SmartwatchService);
  ...
  describe('signUp', () => {
    it('should sign up a user successfully', async () => {
      const mockUser = { id: 1, email: 'test@example.com' } as SmartWatchDevice;
      ...
      const result = await authService.sendSMSCode(signUpDto);
    ...
    it('should encrypt the password', async () => {
      ...
      await authService.sendSMSCode(signUpDto);
    ...
    it('should throw validation error for invalid input', async () => {
      ...
      await expect(authService.sendSMSCode(signUpDto)).rejects.toThrow();
    });
  ...
  describe('signIn', () => {
    it('should sign in a user successfully', async () => {
      ...
      const result = await authService.checkCode(signInDto);
    ...
    it('should throw UserNotFoundException when user does not exist', async () => {
      ...
      await expect(authService.checkCode(signInDto)).rejects.toThrow(
  ...
  describe('getAuthInfo', () => {
    it('should return authentication info', async () => {
      const user: SmartWatchDevice = new SmartWatchDevice();
      user.id = 1;
